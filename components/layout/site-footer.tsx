      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold uppercase font-serif">
              Vintage Legends
            </h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              Bringing back the glory days with authentic vintage football kits
              that celebrate the legends of the beautiful game.
            </p>
            <div className="flex space-x-4">
              <Link
                href="https://www.facebook.com/profile.php?id=61556510023791"
              ...
              <Link
                href="https://www.instagram.com/_tiemdosuy/"
                className="text-muted-foreground hover:text-[#8b0000]"
              >
          ...
          <div className="space-y-4">
            ...
            <div
              className="mt-2 rounded overflow-hidden border"
        ...
        <div className="mt-12 border-t pt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Vintage Legends. All rights
            reserved.
          </p>
          <p className="mt-2">
            Vintage Legends is not affiliated with any football club or
            organization. All product names, logos, and brands are property of
